...
INSERT INTO experiences (
  ...
  NULL,
  'Tickets',
  'https://cdn.getyourguide.com/img/tour/685dd4b34762205c.jpeg/720.jpg',
  '["https://cdn.getyourguide.com/img/tour/685dd4b34762205c.jpeg/720.jpg"]'::jsonb,
  ARRAY['UNESCO World Heritage Site', 'Manueline architecture', 'Tomb of Vasco da Gama', 'Skip-the-queue e-ticket', 'Double cloister'],
  ARRAY['Entrance ticket'],
  ARRAY['English'],
...
INSERT INTO experiences (
  ...
  NULL,
  'Tickets',
  'https://cdn.getyourguide.com/img/tour/b72d9ff047051d5a.jpeg/720.jpg',
  '["https://cdn.getyourguide.com/img/tour/b72d9ff047051d5a.jpeg/720.jpg"]'::jsonb,
  ARRAY['Unlimited metro, tram & bus', 'Free entry to 40+ sites', 'Jerónimos & Tower of Belém included', 'Available in 24h / 48h / 72h', 'Discounts at restaurants'],
  ARRAY['Lisboa Card pass', 'Public transport access', 'Entry to partner museums'],
...
INSERT INTO experiences (
  ...
  NULL,
  'Tickets',
  'https://cdn.getyourguide.com/img/tour/6412f35874f55.jpeg/720.jpg',
  '["https://cdn.getyourguide.com/img/tour/6412f35874f55.jpeg/720.jpg"]'::jsonb,
  ARRAY['Oldest church in Lisbon (12th century)', 'Romanesque architecture', 'Gothic cloisters', 'Treasury with religious artefacts', 'Rose window'],
  ARRAY['Entry ticket', 'Cloisters access'],
  ARRAY['English', 'Portuguese'],
...
INSERT INTO experiences (
  ...
  NULL,
  'Tickets',
  'https://cdn.getyourguide.com/img/tour/d3ecb19bbcd93bbc.jpeg/720.jpg',
  '["https://cdn.getyourguide.com/img/tour/d3ecb19bbcd93bbc.jpeg/720.jpg"]'::jsonb,
  ARRAY['19th-century royal palace', 'Lavish state rooms & throne room', 'Audio guide included', 'Timed entry e-ticket', 'Finest decorative arts collection'],
  ARRAY['Timed entry ticket', 'Audio guide'],
  ARRAY['English', 'Portuguese'],
  'Free cancellation up to 24 hours before',
  4.1,
  88,
...
INSERT INTO experiences (
  ...
  NULL,
  'Tickets',
  'https://cdn.getyourguide.com/img/tour/7f48ccff7af3a77a.jpeg/720.jpg',
  '["https://cdn.getyourguide.com/img/tour/7f48ccff7af3a77a.jpeg/720.jpg"]'::jsonb,
  ARRAY['Train journey from Lisbon to Sintra', 'UNESCO World Heritage village', 'Quinta da Regaleira entry included', 'Initiation Well (27m spiral staircase)', 'Secret tunnels & mystical gardens'],
  ARRAY['Return train ticket', 'Quinta da Regaleira entry', 'Professional guide'],
  ARRAY['English'],
  'Free cancellation up to 24 hours before',
  4.8,
  22,
...
INSERT INTO experiences (
  ...
  NULL,
  'Tickets',
  'https://cdn.getyourguide.com/img/tour/52ebec56dceb8676.jpeg/720.jpg',
  '["https://cdn.getyourguide.com/img/tour/52ebec56dceb8676.jpeg/720.jpg"]'::jsonb,
  ARRAY['One of Europe''s best aquariums', '8,000+ sea creatures', '4 ocean habitats', 'Sea otters, sharks & sunfish', 'Parque das Nações location'],
  ARRAY['Entrance ticket'],
  ARRAY['English', 'Portuguese'],
  'Free cancellation up to 24 hours before',
  4.6,
