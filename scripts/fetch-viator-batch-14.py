#!/usr/bin/env python3
"""
Fetch Viator products for Batch 14 and generate SQL INSERT statements.
...
PRODUCTS = [
    {"code": "66870P3", "category": "Micro Adventures", "url_path": "Hiking-tour-to-the-highest-limestone-cliff-of-continental-Europe"},
    {"code": "5538552P1", "category": "Culture Dive", "url_path": "Lisbon-Fado-and-Fado-Music-Wine-and-History"},
    {"code": "17131P6", "category": "Culture Dive", "url_path": "Belem-district-and-the-Salazar-dictatorship-legacy"},
    {"code": "85308P3", "category": "Culture Dive", "url_path": "Evora-and-Monsaraz"},
    {"code": "63327P5", "category": "Outdoors", "url_path": "Lisbons-Best-Gem-Kayak-and-Snorkeling-Adventure"},
]

START_DISPLAY_ORDER = 63
...
def main():
    sqls = []
    sqls.append(f"""-- ============================================
-- Batch 14: Add {len(PRODUCTS)} Viator experiences to Supabase
