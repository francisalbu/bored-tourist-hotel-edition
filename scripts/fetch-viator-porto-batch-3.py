#!/usr/bin/env python3
"""
Fetch Viator products for Porto Batch 3 and generate SQL INSERT statements.
"""
...
PRODUCTS = [
    {"code": "31913P1",          "category": "Culture Dive",    "url_path": "Skip-the-Line-Port-Wine-Lodges-Tour-Including-7-Wine-Tastings"},
    {"code": "12546DOUROVALLEY", "category": "Outdoors",        "url_path": "Douro-Valley-Small-Group-Tour-with-Wine-Tasting-Portuguese-Lunch-and-Optional-River-Cruise"},
    {"code": "48293P7",          "category": "Local Cooking",   "url_path": "Porto-Food-Tour-Full-Meal-and-Drinks"},
    {"code": "6877P104",         "category": "Outdoors",        "url_path": "Excursion-to-Aveiro-and-Costa-Nova-with-moliceiro-boat-ride"},
    {"code": "8996P137",         "category": "Culture Dive",    "url_path": "Livraria-Lello-Entry-Ticket-Portos-Most-Iconic-Bookstore"},
    {"code": "5902P10",          "category": "Sports",          "url_path": "Porto-Highlights-E-Bike-Tour"},
]

START_DISPLAY_ORDER = 116
DEFAULT_LAT = 41.1579
DEFAULT_LON = -8.6291
...
def main():
    sqls = []
    sqls.append(f"""-- ============================================
-- Porto Batch 3: {len(PRODUCTS)} Viator experiences in Porto
