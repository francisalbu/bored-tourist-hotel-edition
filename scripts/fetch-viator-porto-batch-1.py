#!/usr/bin/env python3
"""
Fetch Viator products for Porto Batch 1 and generate SQL INSERT statements.
...
PRODUCTS = [
    {"code": "7592P12",   "category": "Outdoors",       "url_path": "Douro-Valley-Wine-Tour-with-Lunch-Tastings-and-River-Cruise"},
    {"code": "384973P1",  "category": "Learn & Create", "url_path": "Private-Tile-Painting-Workshop-in-Porto"},
    {"code": "442666P1",  "category": "Sports",         "url_path": "Porto-Surf-Experience"},
    {"code": "122201P7",  "category": "Local Cooking",  "url_path": "Pastel-de-Nata-Pastery-Class"},
    {"code": "406702P4",  "category": "Outdoors",       "url_path": "Porto-Douro-River-Boat-Cruise-with-Port-Wine-and-Snacks"},
]

START_DISPLAY_ORDER = 105
DEFAULT_LAT = 41.1579
DEFAULT_LON = -8.6291
...
def main():
    sqls = []
    sqls.append(f"""-- ============================================
-- Porto Batch 1: {len(PRODUCTS)} Viator experiences in Porto
