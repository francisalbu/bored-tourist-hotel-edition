#!/usr/bin/env python3
"""
Fetch Viator products for Porto Batch 4 and generate SQL INSERT statements.
"""
...
PRODUCTS = [
    {"code": "118678P21", "category": "Micro Adventures", "url_path": "9-Hour-Suspension-Bridge-516-Arouca-and-Passadicos-do-Paiva"},
    {"code": "58705P7",   "category": "Outdoors",         "url_path": "HIKE-in-DOURO-VALLEY-w-winery-and-Boat-Cruise"},
    {"code": "75688P1",   "category": "Culture Dive",     "url_path": "Fado-at-6h"},
    {"code": "26918P6",   "category": "Outdoors",         "url_path": "Braga-and-Guimaraes-with-Lunch-Included-Small-Group-Full-Day"},
    {"code": "7372P18",   "category": "Culture Dive",     "url_path": "Porto-Jewish-Heritage-Walking-Tour"},
    {"code": "43382P8",   "category": "Micro Adventures", "url_path": "Polaris-RZR-Buggy-Tour-4x4"},
]

START_DISPLAY_ORDER = 122
DEFAULT_LAT = 41.1579
DEFAULT_LON = -8.6291
...
def main():
    sqls = []
    sqls.append(f"""-- ============================================
-- Porto Batch 4: {len(PRODUCTS)} Viator experiences in Porto
