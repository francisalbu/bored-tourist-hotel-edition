#!/usr/bin/env python3
"""
Fetch Viator products for Porto Batch 6 and generate SQL INSERT statements.
"""
...
PRODUCTS = [
    {"code": "57617P1",   "category": "Outdoors",        "url_path": "Private-Tour-Viana-do-Castelo-from-Porto"},
    {"code": "18121P3",   "category": "Local Cooking",   "url_path": "Craft-Beer-and-Food-Tour"},
    {"code": "66671P1",   "category": "Learn & Create",  "url_path": "Port-Wine-Cocktails-Workshop-at-Espaco-Porto-Cruz"},
    {"code": "102838P1",  "category": "Learn & Create",  "url_path": "Half-Day-Porto-Photo-Tour"},
    {"code": "203526P17", "category": "Local Cooking",   "url_path": "Beyond-the-Barrel-From-Decadent-to-Down-home-in-the-Heart-of-Porto"},
    {"code": "131810P2",  "category": "Sports",          "url_path": "From-Porto-to-Gaia-Private-Bike-Tour"},
    {"code": "7378P2",    "category": "Micro Adventures", "url_path": "Douro-4x4-Offtrack-Adventure-from-Porto"},
    {"code": "124583P2",  "category": "Outdoors",        "url_path": "Pinhao-private-hike"},
]

START_DISPLAY_ORDER = 134
DEFAULT_LAT = 41.1579
DEFAULT_LON = -8.6291
...
def main():
    sqls = []
    sqls.append(f"""-- ============================================
-- Porto Batch 6: {len(PRODUCTS)} Viator experiences in Porto
