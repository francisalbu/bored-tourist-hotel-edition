#!/usr/bin/env python3
"""
Fetch Viator products for Batch 13 and generate SQL INSERT statements.
...
PRODUCTS = [
    {"code": "279535P1", "category": "Outdoors", "url_path": "Sailing-Tour-on-Tejo-River"},
    {"code": "121012P3", "category": "Wellness", "url_path": "Day-Spa"},
    {"code": "7626P564", "category": "Local Cooking", "url_path": "Private-Traditional-Portuguese-and-Goan-Cooking-Class"},
    {"code": "75380P3", "category": "Outdoors", "url_path": "Kayak-Tour", "city_path": "Setubal-District", "dest": "d5016"},
    {"code": "11392P9", "category": "Culture Dive", "url_path": "The-Jewish-Odyssey-in-Lisbon"},
    {"code": "66870P6", "category": "Micro Adventures", "url_path": "Hiking-tour-to-footprints-of-dinosaur-in-Espichel-Cape"},
]

START_DISPLAY_ORDER = 57
...
def main():
    sqls = []
    sqls.append(f"""-- ============================================
-- Batch 13: Add {len(PRODUCTS)} Viator experiences to Supabase
