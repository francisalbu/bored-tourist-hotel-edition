#!/usr/bin/env python3
"""
Fetch Viator products for Porto Batch 2 and generate SQL INSERT statements.
"""
...
PRODUCTS = [
    {"code": "7372P39",   "category": "Outdoors",      "url_path": "Douro-Valley-Tour-with-Visit-to-two-Vineyards-River-Cruise-and-Lunch-at-Winery"},
    {"code": "204176P3",  "category": "Micro Adventures", "url_path": "SPIRITUS-A-melhor-maneira-de-viajar-e-sentir"},
    {"code": "264534P1",  "category": "Outdoors",      "url_path": "Private-Cruise-on-the-Douro-River"},
    {"code": "154994P1",  "category": "Local Cooking", "url_path": "FOOD-TOURS-IN-PORTO-TO-EAT-LIKE-A-LOCAL"},
    {"code": "174294P3",  "category": "Outdoors",      "url_path": "Private-Sunset-Sailing-Cruise-on-the-Douro-River"},
    {"code": "14873P1",   "category": "Local Cooking", "url_path": "Cook-and-Taste-Porto"},
]

START_DISPLAY_ORDER = 110
DEFAULT_LAT = 41.1579
DEFAULT_LON = -8.6291
...
def main():
    sqls = []
    sqls.append(f"""-- ============================================
-- Porto Batch 2: {len(PRODUCTS)} Viator experiences in Porto
